...
export function CategoryCard({ imageUrl, name, url }: CategoryCardProps) {
  return (
    <Link
      ...
      className='group relative flex h-36 w-[225px] items-end justify-start overflow-hidden rounded-2xl border-[1.5px] border-neutral-800 bg-danger-1000 p-3 shadow duration-300 hover:border-[#62E7DE] hover:shadow-brand'
    >
